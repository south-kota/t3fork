...
const APP_USER_MODEL_ID = isDevelopment ? "com.southkota.t3fork.dev" : "com.southkota.t3fork";
const LINUX_DESKTOP_ENTRY_NAME = isDevelopment ? "t3fork-dev.desktop" : "t3fork.desktop";
const LINUX_WM_CLASS = isDevelopment ? "t3fork-dev" : "t3fork";
const USER_DATA_DIR_NAME = isDevelopment ? "t3fork-dev" : "t3fork";
